...
IUSE="vorbis flac mp4 mp3"

RDEPEND="dev-lang/php[gd,hash,iconv,mysql,session,unicode,xml,zlib]
		 || ( <dev-lang/php-5.3[pcre] >=dev-lang/php-5.3 )
		 vorbis? ( media-sound/lame media-sound/mp3splt media-sound/vorbis-tools )
		 flac? ( media-sound/lame )
		 mp4? ( media-sound/lame )
		 mp3? ( media-sound/lame media-sound/mp3splt )"
DEPEND=""
